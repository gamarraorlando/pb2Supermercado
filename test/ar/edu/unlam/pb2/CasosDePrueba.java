...
public class CasosDePrueba {
	...
	public void queSePuedaInstanciarUnComestible() {
		...
		assertEquals("22/06/2021", producto.getFechaDeElavoracion());
	...
	public void queSePuedaInstanciarOtroComestible() {
		...
		assertEquals("07/07/2021", producto.getFechaDeElavoracion());
	...
	public void queSePuedaInstanciarUnElectrodomestico() {
		...
		assertEquals((Integer)12, producto.getMesesDeGArantia());
	...
	public void queSePuedaInstanciarUnaIndumentaria() {
		...
		assertEquals(talle,(producto.getTalle()));
	...
	@Test
	public void queSePuedaGenerarUnaVenta() throws VentaNoRegistrada {
	...
	public void queNoSePuedaVenderUnProductoInexistente() throws ProductoSinStock, ProductoInexistente, VentaNoRegistrada {
		Supermercado vital = new Supermercado("Vital");
	...
	public void queNoSePuedaVenderUnProductoSinStock() throws ProductoSinStock, ProductoInexistente, VentaNoRegistrada {
		Supermercado vital = new Supermercado("Vital");
	...
	Supermercado vital = new Supermercado("Vital");
		...
		vital.ingresarProducto(new Remera(9, "Básica", "S", "Lacoste", "Roja", 2000.0));
		vital.ingresarProducto(new Galletitas(10, "Oreo", "05/05/2021", "30/03/2022", "Arcor", 150.0));
		Producto esperado= new Galletitas(1, "Cerealitas", "22/06/2021", "31/01/2022", "Arcor", 120.0);
		Producto tieneQueDarError =new Televisor(3, "Serie Dorada", 42, 12, "Samsung", 200000.0);
		 vital.optenerComestibles();
		 Producto optenido= vital.optenerComestibles().first();
